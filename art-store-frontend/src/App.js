      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <nav className="bg-white shadow-md p-4">
          <ul className="flex justify-center space-x-6">
            ...
            <li><Link to="/artworks" className="text-gray-800 hover:text-blue-600 font-medium">Artworks</Link></li>
            <li><Link to="/artists" className="text-gray-800 hover:text-blue-600 font-medium">Artists</Link></li>
            <li><Link to="/membership" className="text-gray-800 hover:text-blue-600 font-medium">Membership</Link></li>
            <li><Link to="/cart" className="text-gray-800 hover:text-blue-600 font-medium">Cart</Link></li>
            <li><Link to="/wishlist" className="text-gray-800 hover:text-blue-600 font-medium">Wishlist</Link></li>
            {user ? (
              <li>
              ...
              <>
                ...
                <li><Link to="/register" className="text-gray-800 hover:text-blue-600 font-medium">Register</Link></li>
              </>
            )}
          </ul>
        </nav>
        ...
        <Routes>
                  ...
                  {loading ? (
                    ...
                    artworks.map((artwork) => (
                      <div key={artwork.id} className="bg-white p-4 rounded-lg shadow-md border border-gray-200">
                        ...
                        <p className="mt-1 text-sm text-gray-500">{artwork.artist} - {artwork.medium || 'N/A'}</p>
          ...
          <Route path="/membership" element={user ? <Membership user={user} /> : <Navigate to="/login" />} />
        </Routes>
      </div>
    </Router>
  );
